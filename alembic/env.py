"""Alembic environment for Shelvr.

Loads settings from the standard Shelvr config layers and targets the
declarative metadata registered on shelvr.db.base.Base.
"""
