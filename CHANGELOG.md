...
- feat(reader): table-of-contents sidebar in EPUB reader

## [0.12.0] - 2026-04-26

- Merge pull request #15 from LightWraith8268/claude/dev
- feat(auth): self-service username change

## [0.11.0] - 2026-04-26

- Merge pull request #14 from LightWraith8268/claude/dev
- feat(reader): theme + font controls and finally wire PdfReader dispatch
...
- feat(reader): native PDF reader and progress overlay on library cards

## [0.8.0] - 2026-04-25

- Merge pull request #10 from LightWraith8268/claude/dev
- feat(reading): per-user reading progress endpoints and reader sync

## [0.7.0] - 2026-04-25

- Merge pull request #9 from LightWraith8268/claude/dev
- feat(web): in-browser EPUB reader at /books/:id/read
